...
const EmployeeProfile = () => {
  ...
  const formattedDate =
    employee &&
    new Date(employee.created_date).toLocaleDateString('en-US', {
      year: 'numeric',
      month: 'long',
      day: 'numeric',
    });
  ...
  return (
    <>
      <Breadcrumb pageName="Employee Profile" />
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <FetchDocuments employeeId={id?.toString()} />
        </div>
      </div>
    </>
  );
